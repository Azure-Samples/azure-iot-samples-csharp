...
namespace Microsoft.Azure.Devices.Samples
{
    ...
    internal class Parameters
    {
        ...
        public bool Validate()
        {
            ...
            {
                throw new ArgumentNullException(nameof(HubConnectionString), "An IoT Hub connection string needs to be specified, please set the environment variable \"IOTHUB_CONNECTION_STRING\"" +
                    "or pass in \"-c | --HubConnectionString\" through command line.");
            }

            if (string.IsNullOrWhiteSpace(DeviceId))
            {
                throw new ArgumentNullException(nameof(DeviceId), "The Id of the plug and play device needs to be specified, please set the environment variable \"IOTHUB_DEVICE_ID\"" +
